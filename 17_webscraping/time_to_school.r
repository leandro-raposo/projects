# pacotes
library("tidyverse") # pct dplyr - funções comuns na manipulação de dados
library(readxl)
...
# "select": tem a finalidade principal de extair variáveis selecionadas 
...
# "summarise": função que resume o dataset, podendo criar outros
...
# "filter" tem o objetivo de gerar subconjuntos do dataset
...
# "filter" seleciona linhas com base em critérios lógicos
# "slice" pode ser utilizada para a seleção de linhas usando posições
...
# "join": utilizadas para realizar a junção (merge) de datasets
